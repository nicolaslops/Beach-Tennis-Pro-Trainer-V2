(() => {
  ...
  function readEnv() {
    ...
    return {
      url: String(env.NEXT_PUBLIC_SUPABASE_URL || env.VITE_SUPABASE_URL || "").trim(),
      key: String(env.NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY || env.VITE_SUPABASE_PUBLISHABLE_KEY || "").trim()
    };
  }
